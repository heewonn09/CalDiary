...
public class FL extends Activity {
    ...
    public class MyGalleryAdapter extends BaseAdapter {
        ...
        Context context;
        Integer[] posterID = {R.drawable.cof, R.drawable.veg, R.drawable.nu, R.drawable.fish,
                R.drawable.sel, R.drawable.tur, R.drawable.gre, R.drawable.gal};//이미지 ID를 배열로 저장하자. 아이디는 십진수
        String[] posterTitle={"커피", "채소", "견과류", "생선",
                "섬유질", "강황", "녹차", "마늘"};
