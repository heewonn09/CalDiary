...
public class HL extends Activity {
    ...
    public class MyGalleryAdapter extends BaseAdapter {
        ...
        Context context;
        Integer[] posterID = {R.drawable.oni, R.drawable.mush, R.drawable.sola, R.drawable.spota,
                R.drawable.cucu, R.drawable.curc, R.drawable.bit, R.drawable.stra};//이미지 ID를 배열로 저장하자. 아이디는 십진수
        String[] posterTitle = {"양파", "표고버섯", "가지", "고구마",
                "오이", "호박", "비트", "딸기"};
