...
public class HBP extends Activity {

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.hbp);
        setTitle("고혈압에 좋은 음식");
    ...
    public class MyGalleryAdapter extends BaseAdapter {
        ...
        Context context;
        Integer[] posterID = {R.drawable.blueb, R.drawable.sal, R.drawable.gal, R.drawable.bro,
                R.drawable.oran, R.drawable.cina, R.drawable.yogu, R.drawable.pota};//이미지 ID를 배열로 저장하자. 아이디는 십진수
        String[] posterTitle={"블루베리", "연어", "마늘", "브로콜리",
                "감귤", "계피", "요거트","감자"};
